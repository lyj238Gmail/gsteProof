theory newparaGste1 imports Main Finite_Set
begin
...
definition consistent::"interpretFunType\<Rightarrow>formula set \<Rightarrow> formula set \<Rightarrow> rule set \<Rightarrow>bool"  where
