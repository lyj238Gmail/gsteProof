...
begin
lemma on_inis:
  assumes b1: "f \<in> (invariants N)" and b2: "ini \<in> {andList (allInitSpecs N)}" and b3: "formEval Interp ini s"
  shows "formEval Interp f s"
  proof -
  ...
  ultimately show "formEval Interp f s"
  by satx
qed
